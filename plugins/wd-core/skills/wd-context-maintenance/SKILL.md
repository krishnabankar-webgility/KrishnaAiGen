---
name: wd-context-maintenance
description: 'Use when updating the unify-enterprise .github/context markdown files from new learnings - reuse checks, de-duplication, stable references, and where call-chain versus master docs belong.'
---

# wd-context-maintenance

The full instructions for this skill are maintained by the WD team inside the
`unify-enterprise` repo. **Read `.github/skills/context-md-maintenance/SKILL.md`** (relative to the repo root)
