---
name: wd-developer
description: 'Use when fixing a bug or implementing a feature in the unify-enterprise C# / VB.NET source - the WD teams implementation process, conventions, and what to understand before touching a god-object controller.'
---

# wd-developer

The full instructions for this skill are maintained by the WD team inside the
`unify-enterprise` repo. **Read `.github/skills/developer-skill.md`** (relative to the repo root)
