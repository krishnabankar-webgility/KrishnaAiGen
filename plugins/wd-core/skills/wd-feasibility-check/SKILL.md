---
name: wd-feasibility-check
description: 'Use when a UD ticket is in Feasibility Check status for the Desktop-Customization team - assess whether a customer request can be built, and at what cost, before committing.'
---

# wd-feasibility-check

The full instructions for this skill are maintained by the WD team inside the
`unify-enterprise` repo. **Read `.github/skills/feasibility-check-skill.md`** (relative to the repo root)
