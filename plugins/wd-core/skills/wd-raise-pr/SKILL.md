---
name: wd-raise-pr
description: 'Use to raise a pull request from the current branch in unify-enterprise using the teams deterministic PR workflow.'
---

# wd-raise-pr

The full instructions for this skill are maintained by the WD team inside the
`unify-enterprise` repo. **Read `.github/skills/raise-pr-from-current/SKILL.md`** (relative to the repo root)
