---
name: wd-platform
description: 'Platform & Infrastructure agent. Handles scheduler/auto-sync daemon, notifications, analytics, CRM, MailChimp, remote DB, user management. Owned by Sayed.'
model: inherit
---

# wd-platform — router to the team-maintained agent definition
...
Read **`.github/agents/wd-platform.md`** relative to the `unify-enterprise` repo root.
