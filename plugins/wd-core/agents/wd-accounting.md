---
name: wd-accounting
description: 'Accounting Adapters agent. Handles QB Desktop, QBO, NetSuite, and Avalara integrations. Owns adapter layer, connection, session, QBXML, OAuth. Owned by Kishan.'
model: inherit
---

# wd-accounting — router to the team-maintained agent definition
...
Read **`.github/agents/wd-accounting.md`** relative to the `unify-enterprise` repo root.
