---
name: wd-architect
description: 'WD Architect agent. Cross-module design reviews for Webgility Desktop. Evaluates impact boundaries, pattern conformance, coupling, and blast radius when a change touches shared interfaces, factories, or multiple module agents. Invoked by wd-master or any domain agent when a change crosses module lines.'
model: inherit
---

# wd-architect — router to the team-maintained agent definition
...
Read **`.github/agents/wd-architect.md`** relative to the `unify-enterprise` repo root.
