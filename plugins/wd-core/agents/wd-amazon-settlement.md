---
name: wd-amazon-settlement
description: 'Amazon Settlement agent. Handles Amazon Settlement download (SP-API via CIS), 5-stage post to accounting, undo sync, and stage tracking. Standalone module — separate from payout flow.'
model: inherit
---

# wd-amazon-settlement — router to the team-maintained agent definition
...
Read **`.github/agents/wd-amazon-settlement.md`** relative to the `unify-enterprise` repo root.
