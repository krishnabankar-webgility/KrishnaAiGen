---
name: wd-shipping
description: 'Shipping agent. Handles all carrier integrations (FedEx, UPS, USPS, Amazon), rate shopping, label creation, InsureShip. Owned by Sayed.'
model: inherit
---

# wd-shipping — router to the team-maintained agent definition
...
Read **`.github/agents/wd-shipping.md`** relative to the `unify-enterprise` repo root.
