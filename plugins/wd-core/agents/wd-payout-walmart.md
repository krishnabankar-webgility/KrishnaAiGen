---
name: wd-payout-walmart
description: 'Walmart DSV payout sub-agent. Handles Walmart-specific payout parsing and adjustments.'
model: inherit
---

# wd-payout-walmart — router to the team-maintained agent definition
...
Read **`.github/agents/wd-payout-walmart.md`** relative to the `unify-enterprise` repo root.
