---
name: wd-inventory
description: 'Inventory agent. Handles inventory sync (QB↔Store), POS, Purchase Orders, and Lokad forecasting. Owned by Hitesh.'
model: inherit
---

# wd-inventory — router to the team-maintained agent definition
...
Read **`.github/agents/wd-inventory.md`** relative to the `unify-enterprise` repo root.
