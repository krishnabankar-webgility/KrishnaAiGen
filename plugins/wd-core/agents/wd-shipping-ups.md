---
name: wd-shipping-ups
description: 'UPS shipping sub-agent. Handles UPS Direct (OAuth REST) and UPS WorldShip (XML file exchange). Rate, label, tracking.'
model: inherit
---

# wd-shipping-ups — router to the team-maintained agent definition
...
Read **`.github/agents/wd-shipping-ups.md`** relative to the `unify-enterprise` repo root.
