---
name: wd-payout-shopify
description: 'Shopify Payouts sub-agent. Handles Shopify Payments payouts (orders, refunds, transaction fees).'
model: inherit
---

# wd-payout-shopify — router to the team-maintained agent definition
...
Read **`.github/agents/wd-payout-shopify.md`** relative to the `unify-enterprise` repo root.
