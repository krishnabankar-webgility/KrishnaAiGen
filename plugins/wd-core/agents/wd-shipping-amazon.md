---
name: wd-shipping-amazon
description: 'Amazon shipping sub-agent. Handles Amazon Buy Shipping (via CIS) and FBA outbound labels.'
model: inherit
---

# wd-shipping-amazon — router to the team-maintained agent definition
...
Read **`.github/agents/wd-shipping-amazon.md`** relative to the `unify-enterprise` repo root.
