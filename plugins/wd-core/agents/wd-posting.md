---
name: wd-posting
description: 'Order Posting & Processing agent. Handles order download from CIS, post to accounting for orders, and AutoSynch bi-directional upload. Owned by Sayed.'
model: inherit
---

# wd-posting — router to the team-maintained agent definition
...
Read **`.github/agents/wd-posting.md`** relative to the `unify-enterprise` repo root.
