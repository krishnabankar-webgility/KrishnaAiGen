---
name: wd-shipping-usps
description: 'USPS/Stamps.com/Endicia shipping sub-agent. Handles all USPS-based carriers. ⚠️ Direct USPS deprecated, use Stamps or Endicia.'
model: inherit
---

# wd-shipping-usps — router to the team-maintained agent definition
...
Read **`.github/agents/wd-shipping-usps.md`** relative to the `unify-enterprise` repo root.
