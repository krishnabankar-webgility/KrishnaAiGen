---
name: wd-master
description: 'Master agent for Webgility Desktop. Receives Jira tickets (standalone) or Ticket Digests (from WG workspace), routes to domain agents, assembles compact output. Read-only advisor — never modifies code directly.'
model: inherit
---

# wd-master — router to the team-maintained agent definition
...
Read **`.github/agents/wd-master.md`** relative to the `unify-enterprise` repo root.
