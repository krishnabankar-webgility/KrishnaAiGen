---
name: wd-payout-settlement
description: 'Payout Processing agent. Handles payout download from CIS and 4-step post to accounting (payments → refunds → adjustments → fees). Owned by Hitesh.'
model: inherit
---

# wd-payout-settlement — router to the team-maintained agent definition
...
Read **`.github/agents/wd-payout-settlement.md`** relative to the `unify-enterprise` repo root.
