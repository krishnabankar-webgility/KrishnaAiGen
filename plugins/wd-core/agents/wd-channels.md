---
name: wd-channels
description: 'Store Channels & Configuration agent. Handles CIS adapter, store profile setup, automation rules, EDI, customer sync, payment config. Owned by Hitesh.'
model: inherit
---

# wd-channels — router to the team-maintained agent definition
...
Read **`.github/agents/wd-channels.md`** relative to the `unify-enterprise` repo root.
