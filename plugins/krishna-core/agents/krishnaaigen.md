...
3. the **`krishnaaigen-skill-evolution`** skill (load it with the Skill tool) — when to update skills after corrections  
...
4. the **`jira-workflow`** skill (load it with the Skill tool)  
5. the **`git-sync`** skill (load it with the Skill tool)  
6. the **`db-restore`** skill (load it with the Skill tool)  
7. the **`bitbucket-unify-enterprise`** skill (load it with the Skill tool)  
8. the **`slack-integration`** skill (load it with the Skill tool)  
9. the **`dev-customization-expertise`** skill (load it with the Skill tool)  
10. the **`dev-customization-workflow`** skill (load it with the Skill tool)  
11. the **`confluence-workflow`** skill (load it with the Skill tool)  
12. the **`daily-work-update`** skill (load it with the Skill tool)  
